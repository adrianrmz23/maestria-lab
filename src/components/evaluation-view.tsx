...
const modes: Array<{ id: ExamMode; title: string; count: number; description: string; note: string }> = [
  ...
  { id: "full", title: "Examen completo", count: 20, description: "Evaluación amplia del módulo con transferencia.", note: "La señal más fuerte para dominio." },
